...
static void MD5Transform PROTO_LIST((word32[4], u_int8_t[64]));
static void Encode PROTO_LIST((u_int8_t *, word32 *, u_int32_t));
static void Decode PROTO_LIST((word32 *, u_int8_t *, u_int32_t));
...
/* Encodes input (word32) into output (u_int8_t). Assumes len is
  a multiple of 4.
 */
...
/* Decodes input (u_int8_t) into output (word32). Assumes len is
  a multiple of 4.
 */
